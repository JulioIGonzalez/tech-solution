...
export function Footer() {
  ...
  const footerLinks = {
    ...
    empresa: [
      ...
      { label: t.nav.faq ?? 'Preguntas', href: '#preguntas-frecuentes' },
        ...
        <div className="grid grid-cols-2 gap-6 sm:gap-8 lg:grid-cols-4">
          ...
          <div className="col-span-2 lg:col-span-1">
            ...
            <div className="mt-4 flex gap-2 sm:mt-6 sm:gap-3">
              <a href={business.social.instagram} target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="footer-social-btn flex h-9 w-9 items-center justify-center rounded-lg bg-dark-800 text-dark-400 transition-all hover:bg-cyber-500/20 hover:text-cyber-400 sm:h-10 sm:w-10">
              ...
              <a href={business.social.facebook} target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="footer-social-btn flex h-9 w-9 items-center justify-center rounded-lg bg-dark-800 text-dark-400 transition-all hover:bg-cyber-500/20 hover:text-cyber-400 sm:h-10 sm:w-10">
              ...
              <a href={`https://t.me/+${business.telegram}`} target="_blank" rel="noopener noreferrer" aria-label="Telegram" className="footer-social-btn flex h-9 w-9 items-center justify-center rounded-lg bg-dark-800 text-dark-400 transition-all hover:bg-sky-500/20 hover:text-sky-400 sm:h-10 sm:w-10">
