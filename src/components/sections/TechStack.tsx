/**
 * Stack Tecnológico - Animaciones con React Awesome Reveal
 */
  ...
  return (
    ...
    >
      <div className="container-wide mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Tech Grid con cascade */}
        <div className="grid gap-4 sm:grid-cols-2 sm:gap-6 lg:grid-cols-3">
          {TECH_STACK.map((category, index) => (
            <Slide key={category.id} direction="up" triggerOnce fraction={0.15} delay={index * 80} duration={400}>
              <div
