/**
 * Servicios - Animaciones con React Awesome Reveal
 */
      ...
      <div className="container-wide mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-2 sm:gap-6 lg:grid-cols-3">
          {SERVICES.map((service, index) => {
            ...
            return (
              <Slide key={service.id} direction="up" triggerOnce fraction={0.15} delay={index * 100} duration={450}>
                <article
                  id={service.slug}
        ...
        {/* CTA adicional */}
        <Fade direction="up" triggerOnce fraction={0.2} delay={300} duration={500}>
