...
export function Hero() {
  ...
  return (
    ...
    >
      {/* Imagen de fondo: AVIF/WebP, prioridad LCP, srcset optimizado */}
      <div className="absolute inset-0 z-0">
        <picture>
          <source
            type="image/avif"
            srcSet="https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&w=800&q=70&fm=avif 800w, https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&w=1200&q=70&fm=avif 1200w"
            sizes="100vw"
          />
          <source
            type="image/webp"
            srcSet="https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&w=800&q=70&fm=webp 800w, https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&w=1200&q=70&fm=webp 1200w"
            sizes="100vw"
          />
          <img
            src="https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&w=800&q=70"
            alt=""
      ...
      >
        <motion.h1
          id="hero-title"
          variants={item}
          className="mt-6 mb-8 max-w-5xl px-4 text-center font-display text-2xl font-extrabold leading-tight tracking-tight xs:text-3xl sm:mt-8 sm:mb-10 sm:px-6 sm:text-4xl md:text-5xl lg:px-8 lg:text-6xl xl:text-7xl"
        >
